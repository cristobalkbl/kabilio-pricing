...
import { AllFeaturesGrid } from "./AllFeaturesGrid";
...
const DEFAULT_ALLFEATURES = [
  { title: "Facturación", text: "Factura conforme a Verifactu con tu diseño, emite facturas recurrentes y, próximamente, presupuestos.", href: "/empresas/facturacion", icon: `<path d="M7 3h7l5 5v13H7z"/><path d="M14 3v5h5"/>` },
    ...
    <>
      ...
      <main className="container">
        ...
        <section className="py-8 pb-16">
          ...
          />
          <AllFeaturesGrid features={allFeatures} />
        </section>
      </main>
    </>
  );
