...
const PLATAFORMA = [
  ...
  { title: "Gestor documental", text: "Toda la documentación de tus clientes, centralizada y buscable.", href: "/asesores/gestor-documental", icon: `<path d="M4 5a2 2 0 0 1 2-2h5l2 3h5a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/>` },
];

export const portalCliente: FeatureLandingData = {
  eyebrow: "Portal del cliente",
  h1: "El portal de tus clientes, conectado con tu despacho",
  ...
  ctas: ASESOR_CTAS,
  hero: {
    invoice: { title: "Portal del cliente", n: "Cliente Demo S.L.", badge: "Conectado", total: { label: "Llega a tu contabilidad", amount: "Al instante" } },
    kpis: [
  ...
  benefits: {
    ...
    text: "El portal facilita el día a día a tus clientes y te devuelve tiempo a ti.",
    items: [
      { icon: `<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>`, h: "Colaboración sin fricción", p: "Toda la información de tus clientes en un solo portal, sin emails ni carpetas sueltas." },
  ...
  features: [
    ...
    },
    {
      ...
      text: "Tus clientes suben tickets y facturas de gasto desde el portal, y la IA de Kabilio extrae los datos. Tú solo revisas y contabilizas, sin teclear.",
      bullets: [
  ...
  testimonials: {
    title: "Despachos que ya dan portal a sus clientes",
  ...
  faqs: [
    ...
    { q: "¿Qué puede hacer el cliente en su portal?", a: "Emitir facturas conforme a Verifactu, subir sus gastos y consultar su información financiera. Tú decides qué acceso le das." },
    ...
    { q: "¿Puedo dar acceso solo a algunos clientes?", a: "Sí. Habilitas el portal a los clientes que quieras y con el alcance que decidas." },
  ...
  allFeaturesHeading: { title: "Toda la plataforma para tu despacho", text: "El portal del cliente, junto al resto de la precontabilidad automatizada con IA." },
