...
export const site = {
  ...
  // Contacto comercial que se muestra en las páginas de contacto.
  salesEmail: "soporte.comercial@kabilio.ai",
  ...
  asesores: [
    {
      ...
      items: [
        ...
        { label: "Kabilio Empresas", href: "/asesores/kabilio-empresas" },
      ],
    },
